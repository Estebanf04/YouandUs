<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            Actualiza tus datos de perfil o tu contraseña.
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            <x-input-label for="nickname" :value="__('Nombre de usuario')" />
        ...
        <div>
            ...
            <div class="image">
                @if(Auth::user()->image)
                    <div>
                         <img style=" border:1px solid; width:100px; max-height:100px; border-radius: 50%; margin-top: 15px;" src="{{route('avatar',['filename' => Auth::user()->image])}}">
                    </div>
                @endif
            </div>
        </div>
